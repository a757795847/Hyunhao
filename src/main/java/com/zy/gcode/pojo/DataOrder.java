...
public class DataOrder {
    ...
    public String toString() {
        return "DataOrder{" +
                ...
                ", giftState=" + giftState +
                ", commentFile1='" + commentFile1 + '\'' +
                ", commentFile2='" + commentFile2 + '\'' +
                ", commentFile3='" + commentFile3 + '\'' +
                ", applyDate=" + applyDate +
                ...
                ", actualPayPoints='" + actualPayPoints + '\'' +
                ...
                ", phaseOrderInfo='" + phaseOrderInfo + '\'' +
                ", privilegeOrderId='" + privilegeOrderId + '\'' +
                ", isTransferAgreementPhoto='" + isTransferAgreementPhoto + '\'' +
                ", isTransferReceipt='" + isTransferReceipt + '\'' +
                ", isPayByAnother='" + isPayByAnother + '\'' +
                ", earnestRanking='" + earnestRanking + '\'' +
                ", skuChanged='" + skuChanged + '\'' +
                ", receiverAddressChanged='" + receiverAddressChanged + '\'' +
                ", errorInfo='" + errorInfo + '\'' +
                ", tmallCardsDeduction='" + tmallCardsDeduction + '\'' +
                ", pointDedution='" + pointDedution + '\'' +
                ", isO2OTrade='" + isO2OTrade + '\'' +
                '}';
    }
}
