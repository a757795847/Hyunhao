...
public class CodeImage {
    ...
    public CodeImage(int width, int height) {
        this.width = width;
        this.height = height;
        creatImage();
    }

    public CodeImage(int width, int height, int codeCount) {
        this.width = width;
        this.height = height;
    ...
    public CodeImage(int width, int height, int codeCount, int lineCount) {
        this.width = width;
        this.height = height;
        this.codeCount = codeCount;
